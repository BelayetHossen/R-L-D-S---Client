                                ...
                                }
                                {
                                    ...
                                    <>
                                        <div className="group cursor-pointer">
                                            ...
                                            <div className="invisible absolute z-50 flex w-full flex-col bg-gray-100 py-1 text-gray-800 shadow-xl group-hover:visible w-auto -ms-6">
                                                {
                                                    skip13NextCategories &&
                                                    skip13NextCategories.map((item) => (
                                                        <Link key={item.id} to={'/'} className="block border-b border-gray-300 py-2 font-semibold text-gray-700 hover:bg-gray-200 md:px-4">
                                                            {item.name}
                                                        </Link>
                                                    ))
                                                }
